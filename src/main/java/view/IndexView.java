    ...
    private void initComponents() {
        ...
        //======== content ========
        {
            ...
            //======== panel2 ========
            {
                ...
                ((GridBagLayout)panel2.getLayout()).columnWidths = new int[] {245, 0, 0, 0};
                ((GridBagLayout)panel2.getLayout()).rowHeights = new int[] {189, 177, 27, 0};
                ...
                panel2.add(scrollPane1, new GridBagConstraints(0, 0, 1, 2, 0.0, 0.0,
                ...
                panel2.add(desktopPane1, new GridBagConstraints(1, 0, 2, 1, 0.0, 0.0,
                    GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                ...
                panel2.add(desktopPane2, new GridBagConstraints(1, 1, 2, 1, 0.0, 0.0,
                    GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                    new Insets(0, 0, 5, 0), 0, 0));
                ...
                panel2.add(checkBoxTodosChamados, new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0,
                    GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                ...
                panel2.add(novoChamadoButton, new GridBagConstraints(1, 2, 1, 1, 0.0, 0.0,
                    GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                    new Insets(0, 0, 0, 5), 0, 0));
